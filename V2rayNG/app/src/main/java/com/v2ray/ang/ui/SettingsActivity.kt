...
class SettingsActivity : BaseActivity() {
    ...
    class SettingsFragment : PreferenceFragmentCompat() {
        ...
        override fun onCreatePreferences(bundle: Bundle?, s: String?) {
            ...
            // Locked build: disable subscription auto-update completely.
            // Also cancel any previously scheduled worker.
            cancelUpdateTask()
            autoUpdateCheck?.setVisible(false)
            autoUpdateInterval?.setVisible(false)
